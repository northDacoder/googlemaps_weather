...
console.log("instafeed file has been loaded"); 
    ...
    function Instafeed(params) {
      ...
      this.options = {
        ...
        success: function(json) {
            instajson = json; 
            console.log("Your instajson object has been loaded: " + instajson);    
        }
      };
      ...
      if (this.options.sortBy !== 'most-recent') {
        ...
        switch (sortSettings[1]) {
          ...
          case 'commented':
            ...
            break;
          // CODE EDITED BY JOHNNY 
          case 'location':
            response.data = this._sortBy(response.data, '')
          default:
